...
{
    [Authorize]
    public class MembersController(IMemberRepository repo, IPhotoService photoService) : BaseApiController
    {
        [HttpGet]
        public async Task<ActionResult<IReadOnlyList<Member>>> GetMembers([FromQuery] MemberParams memberParams)
        {
            ...
            return Ok(await repo.GetMembersAsync(memberParams));
        }
        ...
        {
            var member = await repo.GetMemberForUpdate(User.GetMemberId());
        ...
        public async Task<ActionResult> DeletePhoto(int photoId)
        {
            ...
            return BadRequest("Cannot delete the photo");
        }
    }
}
